  ...
  pi.on("before_agent_start", async (event, ctx) => {
    try {
      ...
      contextLines.push(
		...
		"Use knowledge tools when context should persist beyond the current thread: query_project_knowledge(query), query_goal_knowledge(query), and record_goal_knowledge_note(title?, text, metadata?). Use them for no-code cards, decisions, and lifecycle facts that child workspaces should inherit.",
