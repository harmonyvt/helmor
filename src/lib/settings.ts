...
export type AppSettings = {
	...
	/** Optional Pi model override for Diff review sessions. */
	diffSummaryModelId: string | null;
...
const SETTINGS_KEY_MAP: Record<Exclude<keyof AppSettings, "theme">, string> = {
	...
	diffSummaryModelId: "app.diff_summary_model_id",
...
export async function loadSettings(): Promise<AppSettings> {
	try {
		...
		return {
			...
			diffSummaryModelId:
				raw[SETTINGS_KEY_MAP.diffSummaryModelId] ||
				DEFAULT_SETTINGS.diffSummaryModelId,
