...
export type GoalSupervisorAuthBootstrapResult = {
	readonly anthropic: boolean;
	readonly openaiCodex: boolean;
};

export function bootstrapGoalSupervisorAuth(
	authStorage: AuthStorage,
): GoalSupervisorAuthBootstrapResult {
	return {
		anthropic: bootstrapClaudeAuth(authStorage),
		openaiCodex: bootstrapCodexAuth(authStorage),
	};
}
