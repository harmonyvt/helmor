...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::editor_commands::list_workspace_git_panel,
            ...
            commands::editor_commands::push_git_context_to_remote,
            commands::editor_commands::list_git_context_remote_branches,
            commands::editor_commands::prefetch_git_context_remote_refs,
            commands::editor_commands::update_git_context_target_branch,
            commands::editor_commands::sync_git_context_with_target_branch,
            commands::editor_commands::refresh_git_context_pr_cache,
