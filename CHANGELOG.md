...
- [`486d769`](https://github.com/dohooo/helmor/commit/486d76936dbbbcf388c2bbb38e89731d3c415fb2) Thanks [@harmonyvt](https://github.com/harmonyvt)! - Add submodule support to the Git panel so each submodule shows up as its own context with its own branch, change list, and actions:
...
- [`4b2b06d`](https://github.com/dohooo/helmor/commit/4b2b06dccf7d17693b1a78bb6d58147b27ac7d0c) Thanks [@harmonyvt](https://github.com/harmonyvt)! - Add the non-1M Claude Opus 4.8 option to the Claude Code model list.
